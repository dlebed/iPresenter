#ifndef ADMINSERVERTASK_H
#define ADMINSERVERTASK_H
...
class AdminServerTask : public QRunnable
{
public:
    enum ADMIN_TAST_ERRORS {
        E_OK                    =   0x00,
        E_UNKNOWN_CMD           =   0x01,
    ...
    AdminServerTask(int socketDescriptor);
...
private:
    ...
    AdminCommandExecutor *commandExecutor;
    
    
};

#endif // ADMINSERVERTASK_H
